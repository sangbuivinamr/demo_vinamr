...
const QuotaManagement = (props) => {
  ...
  const onSwappingQuotaRow = (swapType) => {
    ...
    for (
      let quotaIndex = 0;
      quotaIndex < currentQuotaData.length;
      quotaIndex++
    ) {
      if (
        currentQuotaData[quotaIndex]["quota_label"] ===
        quotaClickStatus.quotaLabel
      )
  ...
  return (
    <div className="quota-page">
      ...
      <div className="quota-page--tables" onMouseUp={handleExpressionHighlight}>
        ...
        />
        <ExpressionReview
          expressionReviewData={EXPRESSION_REVIEW_DATA}
